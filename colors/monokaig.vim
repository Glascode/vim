"monokaig - dark colorscheme for vim-editor
"Based on the template of 'evening' colorscheme from Haron Prime.
"Author - Glascode
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("Typedef", s:blue, "", "bold")
	...
	call <SID>X("vimFuncKey", s:blue, "", "")
	call <SID>X("vimFunction", s:lyme, "", "")
	call <SID>X("vimNotFunc", s:red, "", "")
	call <SID>X("vimMap", s:red, "", "")
	call <SID>X("vimAutoEvent", s:lyme, "", "")
	call <SID>X("vimMapModKey", s:aqua, "", "")
	call <SID>X("vimFuncName", s:purple, "", "")
	call <SID>X("vimIsCommand", s:foreground, "", "")
	call <SID>X("vimFuncVar", s:foreground, "", "")
	call <SID>X("vimLet", s:blue, "", "")
	call <SID>X("vimMapRhsExtend", s:foreground, "", "")
	call <SID>X("vimCommentTitle", s:comment, "", "bold")
	call <SID>X("vimBracket", s:red, "", "")
	call <SID>X("vimParenSep", s:foreground, "", "")
	call <SID>X("vimSynType", s:red, "", "")
	call <SID>X("vimNotation", s:red, "", "")
	call <SID>X("vimOper", s:red, "", "")
	...
	call <SID>X("htmlString", s:yellow, "", "")
	...
	call <SID>X("markdownH1", s:orange, "", "bold")
	call <SID>X("markdownH2", s:orange, "", "")
	call <SID>X("markdownH3", s:orange, "", "")
	call <SID>X("markdownH4", s:orange, "", "")
	call <SID>X("markdownH5", s:orange, "", "")
	call <SID>X("markdownH6", s:orange, "", "")
	call <SID>X("markdownBlockquote", s:blue, "", "")
	call <SID>X("markdownCodeBlock", s:red, "", "")
	call <SID>X("markdownLink", s:blue, "", "")
	call <SID>X("markdownBold", s:red, "", "bold")
	call <SID>X("markdownItalic", s:red, "", "none")
	call <SID>X("markdownCode", s:purple, "", "none")
	call <SID>X("markdownLink", s:blue, "", "")
	call <SID>X("markdownURL", s:blue, "", "none")
	call <SID>X("mkdString", s:yellow, "", "none")
	call <SID>X("mkdBlockQuote", s:blue, "", "none")
