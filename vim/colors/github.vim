"gitimproved - light github-like colorscheme for vim-editor
...
let s:comment         = "656b70"
let s:window          = "252525"
let s:tab_bg          = "353535"
let s:tab_fg          = "bbbbbb"
let s:linenr_bg       = "252525"
let s:linenr_fg       = "babbbd"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("sqlStatement", s:red, "", "bold")
	call <SID>X("sqlType", s:red, "", "")
	call <SID>X("sqlKeyword", s:red, "", "")
	call <SID>X("sqlOperator", s:red, "", "")
	call <SID>X("sqlSpecial", s:blue, "", "")
	call <SID>X("mysqlVariable", s:red, "", "")
	call <SID>X("mysqlType", s:red, "", "")
	call <SID>X("mysqlKeyword", s:red, "", "")
	call <SID>X("mysqlOperator", s:red, "", "")
